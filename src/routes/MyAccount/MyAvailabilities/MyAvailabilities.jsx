      ...
      <Grid container spacing={2} sx={{marginTop: 5}} >
          ...
          selectedOffice !== -1 && weekday !== -1 ? (
            <>
              <Grid item xs={12} justifyContent={'center'}>
                <Typography color={'primary'}>Los rangos dispoinibles para la oficina y dia seleccionados son:</Typography>
              </Grid>
              <Grid item xs={12}>
                {
              ...
              <Grid item xs={12} justifyContent={'center'}>
                <Typography>Por favor selecciona un horario a atender dentro de los rangos dispobibles</Typography>
              </Grid>
              <AvailabilityInput
                disabled={false}
                value={startHour}
        ...
        }
        {
          endHour !== -1 ? (
            <>
              <Grid item xs={12} justifyContent={'center'}>
                <Typography color={'primary'}>Por favor selecciona la frecuencia (en minutos) con la que quieres recibir turnos</Typography>
              </Grid>
              <AvailabilityInput
                disabled={false}
                value={frequency}
